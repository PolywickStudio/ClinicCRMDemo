...
uses
  ...
  Vcl.Themes,
  Vcl.Styles,
  uConsultation in 'uConsultation.pas' {ConsultationForm},
  uPatientSelection in 'uPatientSelection.pas' {PatientSelectionForm},
  uPrescription in 'uPrescription.pas' {PrescriptionForm},
  uDoctorSelection in 'uDoctorSelection.pas' {DoctorSelectionForm};
